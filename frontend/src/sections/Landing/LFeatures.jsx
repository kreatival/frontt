    ...
    <div className="bg-[#FAFDFF] py-[70px] flex flex-col gap-8 justify-center items-center sm:border-b-2">
      ...
      <div className="w-full">
        <ul className="flex flex-wrap justify-center w-full gap-4 px-6 sm:px-0">
          <div className="flex flex-col rounded-lg sm:max-w-[214px] max-w-[138px] w-full items-center py-7 px-4 gap-4 border border-[#193B67] border-opacity-15 text-center sm:max-h-[176px] max-h-[145px] h-full">
